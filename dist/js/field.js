...
Nova.booting(function (Vue, router) {
    Vue.component('index-belongs-to-badge', __webpack_require__(3));
    Vue.component('detail-belongs-to-badge', __webpack_require__(6));
});
            ...
            _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass:
                      "rounded-full uppercase px-2 py-1 text-xs font-bold whitespace-no-wrap",
                    style: {
                      backgroundColor: _vm.field.backgroundColor,
                      color: _vm.field.foregroundColor
                    }
                  },
            ...
            ? _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "rounded-full uppercase px-2 py-1 text-xs font-bold",
                      style: {
                        backgroundColor: _vm.field.backgroundColor,
                        color: _vm.field.foregroundColor
                      }
